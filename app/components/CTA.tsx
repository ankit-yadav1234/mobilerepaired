export default function CTA() {
  return (
    <section className="py-12 px-4">
      <div className="max-w-5xl mx-auto bg-white rounded-3xl shadow-[0px_8px_30px_-10px_rgba(0,0,0,0.15)] px-6 py-10 md:px-10 md:py-14 text-center">

        {/* Heading */}
        <h2 className="text-3xl md:text-4xl font-semibold text-neutral-700 leading-snug">
